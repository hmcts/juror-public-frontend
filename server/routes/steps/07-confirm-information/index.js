;(function(){
  ...
  module.exports = function(app) {
    ...
    // eslint-disable-next-line max-len
    app.get('/steps/07-confirm-information/tp', 'steps.confirm.information.tp.get', auth.verify, auth.completeCheck, utils.checkPageAccess(app, 7), controller.index(app));
