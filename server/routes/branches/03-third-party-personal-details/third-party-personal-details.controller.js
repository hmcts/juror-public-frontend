...
;(function(){
  ...
  //
  // Functions added for GDS update
  //
  ...
  module.exports.changeName = function(app){
    return function(req, res){
      req.session.change = true;
      res.redirect(app.namedRoutes.build('branches.third.party.personal.details.name.get'));
    };
  };
  ...
  module.exports.getAddress = function(app) {
    return function(req, res) {
      var getDetailsSuccess = function(response) {
          var addressError
            , tmpErrors
  ...
  module.exports.createAddress = function(app) {
    return function(req, res) {
      var validatorResult
        // Join parts of address
        , addressRender = [
  ...
  module.exports.changeAddress = function(app){
    return function(req, res){
      req.session.change = true;
      res.redirect(app.namedRoutes.build('branches.third.party.personal.details.address.get'));
    };
  };
