    ...
    return {
      ...
      mentalHealthCapacityDetails: {
        ...
        length: {
          maximum: 1000,
          message: {
            summary: filters.translate('VALIDATION.QUALIFY.MENTAL_HEALTH_CAPACITY_LENGTH', (req.session.ulang === 'cy' ? texts_cy : texts_en)),
            details: filters.translate('VALIDATION.DEFERRAL.MENTAL_HEALTH_CAPACITY_LENGTH_ERROR', (req.session.ulang === 'cy' ? texts_cy : texts_en))
          }
        },
      },
    };
