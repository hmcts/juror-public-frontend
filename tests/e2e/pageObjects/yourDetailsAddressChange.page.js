...
class YourDetailsAddressChangePage extends Page {
  constructor() {
    super('/02-your-details/address-change', 'Reply to a jury summons - GOV.UK', 'Personal Details Address Change');
  }
...
module.exports = YourDetailsAddressChangePage;
