...
class ThirdPartyPersonalAddressChangePage extends Page {
  constructor() {
    super('/branches/03-third-party-personal-details/address-change', 'More juror details - GOV.UK', '3rd Party Personal Details Address Change');
  }
...
module.exports = ThirdPartyPersonalAddressChangePage;
